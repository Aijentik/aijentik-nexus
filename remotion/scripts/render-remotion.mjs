...
const composition = await selectComposition({ serveUrl: bundled, id: "aijentik-final-ad", puppeteerInstance: browser });
await renderMedia({ composition, serveUrl: bundled, codec: "h264", outputLocation: "/tmp/aijentik-final-muted.mp4", puppeteerInstance: browser, muted: true, concurrency: 1, crf: 18 });
